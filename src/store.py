...
DEFAULT_DATA = {
    ...
    "invoices": [
        {"id": "INV-1001", "client": "Northwind Traders", "amount": 12500.00, "status": "open", "due": "2026-10-01"},
        {"id": "INV-1002", "client": "Contoso Ltd", "amount": 8400.00, "status": "paid", "due": "2026-08-15"},
        {"id": "INV-1003", "client": "Globex Corp", "amount": 22450.00, "status": "open", "due": "2026-10-15"},
        {"id": "INV-1004", "client": "Initech", "amount": 3180.00, "status": "overdue", "due": "2026-09-01"},
    ],
    "employees": [
        {"id": "E-001", "name": "Maya Patel", "role": "CTO", "salary": 195000, "status": "active"},
        {"id": "E-002", "name": "Jonas Weber", "role": "Sales Lead", "salary": 128000, "status": "active"},
        {"id": "E-003", "name": "Aisha Khan", "role": "Staff Engineer", "salary": 142000, "status": "active"},
        {"id": "E-004", "name": "Tom O'Brien", "role": "Finance Manager", "salary": 118000, "status": "active"},
        {"id": "E-005", "name": "Elena Rossi", "role": "Product Designer", "salary": 96000, "status": "on_leave"},
    ],
    "roles": [
    ...
    "leads": [
        {"id": "L-01", "company": "Northwind Traders", "contact": "Bob James", "stage": "qualified", "value": 60000},
        {"id": "L-02", "company": "Globex Corp", "contact": "Dana Scully", "stage": "proposal", "value": 155000},
        {"id": "L-03", "company": "Hooli", "contact": "Gavin Belson", "stage": "contacted", "value": 40000},
    ],
    "customers": [
        {"id": "C-01", "company": "Northwind Traders", "tier": "gold", "contract_value": 250000},
        {"id": "C-02", "company": "Contoso Ltd", "tier": "silver", "contract_value": 120000},
        {"id": "C-03", "company": "Initech", "tier": "bronze", "contract_value": 45000},
    ],
    "opportunities": [
        {"id": "OP-1", "account": "Globex Corp", "stage": "proposal", "amount": 155000, "probability": 0.6},
        {"id": "OP-2", "account": "Hooli", "stage": "discovery", "amount": 40000, "probability": 0.3},
    ],
    "projects": [
        {"id": "P-01", "name": "Platform Migration", "owner": "E-003", "budget": 180000, "spent": 96000},
        {"id": "P-02", "name": "Mobile App v2", "owner": "E-001", "budget": 120000, "spent": 22000},
    ],
    "tasks": [
    ...
    "expenses": [
        {"id": "X-5001", "category": "Software", "amount": 4800.00, "status": "pending"},
        {"id": "X-5002", "category": "Travel", "amount": 1290.00, "status": "approved"},
        {"id": "X-5003", "category": "Marketing", "amount": 7500.00, "status": "pending"},
    ],
    "revenue": [
        {"period": "2026-07", "amount": 142000.00},
        {"period": "2026-08", "amount": 158000.00},
        {"period": "2026-09", "amount": 171000.00},
    ],
    "schedule": [
